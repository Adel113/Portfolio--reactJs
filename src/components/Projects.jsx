...
class Projects extends React.Component {
  ...
  render() {
    ...
    const styles = {padding : "60px", background: "#0D0D0D" , borderRadius: "200px 40px 40px 40px" , marginBottom: "60px" ,  boxShadow: "0px 0px 70px #fff", zIndex : "1"};
    const imgStyle = {margin : "auto", padding : "20px"};
    const H2CStyle = { textAlign: "center"  , marginBottom: "60px"};
    const H2zCStyle = { textAlign: "center"  , backgroundColor: "#fff" , borderRadius: "60px" , color : "#000"};
          ...
          <div className="row">
              <div className="col-md-12">
                <div className="bounce-top scroll-animation">
                  <img className="center" style={{ display: "block", width: "50%" , margin:"auto" }} alt="séparation de la page" src="pictures/pEtC/projet-web.png" />
                </div>
              </div>
          </div>
        </div>
        <section id="projets" style={styles}className="projets">
          ...
          <div className="carousel-inner">
            ...
            {items.map((item, index) => (
              ...
              >
                <img src={item.src} alt={item.alt} className="d-block w-100"  style={imgStyle}/>
